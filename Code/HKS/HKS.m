...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>matlab/HKS.m at master · areslp/matlab</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars2.githubusercontent.com/u/100579?v=3&amp;s=400" property="og:image" /><meta content="areslp/matlab" property="og:title" /><meta content="https://github.com/areslp/matlab" property="og:url" /><meta content="Contribute to matlab development by creating an account on GitHub." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="52D81661:0F97:13EF6178:54846E55" name="octolytics-dimension-request_id" /><meta content="5080078" name="octolytics-actor-id" /><meta content="Al-th" name="octolytics-actor-login" /><meta content="464376494aa18e7f1810f38ad78d1dfda96af060957b08e7dad6d318b490291a" name="octolytics-actor-hash" />
...
<meta content="Qq59y/jYMlj+5KI4dKmFsHEdMNSg+qFdZJ5Onps2LdnX83sxFwKZiE49PEw8THn+DyKwOVrgC3rx71aZgK1I2g==" name="csrf-token" />
...
<ul class="dropdown-menu">
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="HKDi3WIC+7zTNnidjSZxjwH/NtwKLHbXr4J1TP6VXzIaY7fQ7uQg4oakuwS6qxvYXHzkksfgPDnyXy78m9iOjQ==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="9uvZSzb2vmHSxgMU9WGNggoH2gWeqeYOHJj+0qD8Y//M3iTT+yiChoRvnskiqUv0kYlmnUhWbrd60hAxPwEhcw==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="6501012" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/areslp/matlab/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="DHUpG8WtXLpu/JhvvRh1sNSvdG+0+SjU/SDb6IkHTVkDOF+e0eD4nR4aILJjJTBB924haPOqdtgsJlpGhR9p/g==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/areslp/matlab/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="FRx3/Xr3Dg5d2llLW6eKgsb0kK3wnCzgQ77KF7s25JolnWgg725wY8IWP/gzbuwBA1gxLNlyuNZhKgDLJKlWBw==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/areslp/matlab/blob/d41f05367eabe0970a7ee3b4107b49c3f65cc980/HKS/HKS_release/HKS.m" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:294d2131b189fa4b94c334096305c23d -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/areslp/matlab/blob/master/HKS/HKS_release/HKS.m"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
...
<div class="file-box">
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          <a href="/areslp/matlab/raw/master/HKS/HKS_release/HKS.m" class="minibutton " id="raw-url">Raw</a>
            <a href="/areslp/matlab/blame/master/HKS/HKS_release/HKS.m" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/areslp/matlab/commits/master/HKS/HKS_release/HKS.m" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

          <a class="octicon-button tooltipped tooltipped-nw"
             href="github-windows://openRepo/https://github.com/areslp/matlab?branch=master&amp;filepath=HKS%2FHKS_release%2FHKS.m" aria-label="Open this file in GitHub for Windows">
              <span class="octicon octicon-device-desktop"></span>
          </a>

              <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
                 aria-label="Clicking this button will fork this project so you can edit the file"
                 href="/areslp/matlab/edit/master/HKS/HKS_release/HKS.m"
                 data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

            <a class="octicon-button danger tooltipped tooltipped-s"
               href="/areslp/matlab/delete/master/HKS/HKS_release/HKS.m"
  ...
  <div class="blob-wrapper data type-matlab">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code js-file-line"><span class="pl-st">function</span> [<span class="pl-v">hks</span>] = <span class="pl-en">HKS</span>(evecs, evals, A, <span class="pl-s3">scale</span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC7" class="blob-code js-file-line"><span class="pl-c">%  scale:  if scale = true, output the scaled hks</span></td>
      </tr>
      <tr>
        <td id="L8" class="blob-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-code js-file-line"><span class="pl-c">%          o.w. ouput the hks that is not scaled</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC10" class="blob-code js-file-line"><span class="pl-c">% OUTPUTS</span></td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code js-file-line"><span class="pl-c">%  hks: ith row in this matrix is the heat kernel signature of the ith vertex</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC14" class="blob-code js-file-line">   <span class="pl-c">%area = sum(A);</span></td>
      </tr>
      <tr>
        <td id="L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-code js-file-line">   <span class="pl-c">%A = (1/area) * A;</span></td>
      </tr>
      <tr>
        <td id="L16" class="blob-num js-line-number" data-line-number="16"></td>
        <td id="LC16" class="blob-code js-file-line">   <span class="pl-c">%evals = area * evals;</span></td>
      </tr>
      <tr>
        <td id="L17" class="blob-num js-line-number" data-line-number="17"></td>
        <td id="LC17" class="blob-code js-file-line">   <span class="pl-c">%evecs = sqrt(area) * evecs;</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC19" class="blob-code js-file-line">   tmin = <span class="pl-k">abs</span>(<span class="pl-c1">4</span><span class="pl-k">*</span><span class="pl-k">log</span>(<span class="pl-c1">10</span>)<span class="pl-k"> / </span>evals(<span class="pl-k">end</span>));</td>
      </tr>
      <tr>
        <td id="L20" class="blob-num js-line-number" data-line-number="20"></td>
        <td id="LC20" class="blob-code js-file-line">   tmax = <span class="pl-k">abs</span>(<span class="pl-c1">4</span><span class="pl-k">*</span><span class="pl-k">log</span>(<span class="pl-c1">10</span>)<span class="pl-k"> / </span>evals(<span class="pl-c1">2</span>));</td>
      </tr>
      <tr>
        <td id="L21" class="blob-num js-line-number" data-line-number="21"></td>
        <td id="LC21" class="blob-code js-file-line">   nstep = <span class="pl-c1">100</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC23" class="blob-code js-file-line">   stepsize = (<span class="pl-k">log</span>(tmax)<span class="pl-k"> - </span><span class="pl-k">log</span>(tmin))<span class="pl-k"> / </span>nstep;</td>
      </tr>
      <tr>
        <td id="L24" class="blob-num js-line-number" data-line-number="24"></td>
        <td id="LC24" class="blob-code js-file-line">   logts = <span class="pl-k">log</span>(tmin)<span class="pl-k">:</span>stepsize<span class="pl-k">:</span><span class="pl-k">log</span>(tmax);</td>
      </tr>
      <tr>
        <td id="L25" class="blob-num js-line-number" data-line-number="25"></td>
        <td id="LC25" class="blob-code js-file-line">   ts = <span class="pl-k">exp</span>(logts);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC27" class="blob-code js-file-line">   <span class="pl-k">if</span> <span class="pl-s3">scale</span><span class="pl-k"> == </span><span class="pl-c1">true</span>, </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC29" class="blob-code js-file-line">      Am = <span class="pl-k">sparse</span>([<span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-k">length</span>(A)], [<span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-k">length</span>(A)], A);</td>
      </tr>
      <tr>
        <td id="L30" class="blob-num js-line-number" data-line-number="30"></td>
        <td id="LC30" class="blob-code js-file-line">      colsum = <span class="pl-k">sum</span>(Am<span class="pl-k">*</span>hks);</td>
      </tr>
      <tr>
        <td id="L31" class="blob-num js-line-number" data-line-number="31"></td>
        <td id="LC31" class="blob-code js-file-line">      <span class="pl-s3">scale</span> = <span class="pl-c1">1.0</span><span class="pl-k">./ </span>colsum; </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC33" class="blob-code js-file-line">      hks = hks<span class="pl-k"> * </span>scalem;</td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.06953s from github-fe139-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
