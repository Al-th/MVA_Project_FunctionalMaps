...
for horseNb = 1:size(testedHorses,2)
    ...
    for commutativityIndex = 1:size(Commutativity,2)
        shape1.fun_segment = [];
        shape2.fun_segment = [];

        W = zeros(1608,1);
        weightWKS = Commutativity(1);
        weightHKS = Commutativity(1);
        weightSegment = Commutativity(1);
        weightWKSComm = Commutativity(commutativityIndex);
        weightHKSComm = Commutativity(commutativityIndex);
        weightSegmentComm = Commutativity(commutativityIndex);
        ...
        infos = ['Commutativity : ' num2str(Commutativity(commutativityIndex)) ];
        
        %% Saving stuff
        corrFileName = ['Result_scripts\Commutativity\horse' num2str(testedHorses(horseNb)) '-correspondancesAtError' num2str(commutativityIndex) '.mat'];
        infoFileName = ['Result_scripts\Commutativity\horse' num2str(testedHorses(horseNb)) '-info' num2str(commutativityIndex) '.mat'];
